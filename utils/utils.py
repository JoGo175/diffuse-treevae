...
def prepare_config(args, project_dir):
	...
	if isinstance(configs['training']['latent_channels'], str):
		a = configs['training']['latent_channels'].split(",")
		configs['training']['latent_channels'] = [int(i) for i in a]
	if isinstance(configs['training']['bottom_up_channels'], str):
		a = configs['training']['bottom_up_channels'].split(",")
		configs['training']['bottom_up_channels'] = [int(i) for i in a]
